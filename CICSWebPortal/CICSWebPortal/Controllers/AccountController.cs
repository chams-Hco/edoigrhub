...
namespace CICSWebPortal.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public AccountController() : this(MainContainer.DataService())
        {
        }

        public AccountController(IDataService DataContext)
        {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var result = DataContext.LoginUser(model.Email, model.Password);
